...
```
// 请求 { "jsonrpc": "2.0", "method": "tools/call", "params": { "name": "get_weather", "arguments": {"city": "Beijing"} }, "id": 1 } // 成功响应 { "jsonrpc": "2.0", "result": { "content": [{"type": "text", "text": "北京今天晴，25°C"}] }, "id": 1 } // 错误响应 { "jsonrpc": "2.0", "error": { "code": -32602, "message": "Invalid params", "data": "city is required" }, "id": 1 }
```
...
```
[ {"jsonrpc": "2.0", "method": "tools/list", "id": 1}, {"jsonrpc": "2.0", "method": "resources/list", "id": 2}, {"jsonrpc": "2.0", "method": "prompts/list", "id": 3} ]
```
...
```
{ "name": "get_weather", "description": "获取天气信息", "inputSchema": { "type": "object", "properties": { "city": { "type": "string", "description": "城市名称" } }, "required": ["city"] } }
...
> Source: https://t.zsxq.com/oacL6
> Resolved: https://articles.zsxq.com/id_lcju88pl5tmq.html
