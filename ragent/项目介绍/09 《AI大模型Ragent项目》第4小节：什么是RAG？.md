...
![无法获取该图片](https://oss.open8gu.com/image-20260213171102260.png)
...
![无法获取该图片](https://oss.open8gu.com/image-20260213111819411.png)
...
![无法获取该图片](https://oss.open8gu.com/image-20260213112325650.png)
...
```
用户：我们公司的 XX-2000 型号服务器的 BIOS 怎么设置？​模型：抱歉，我没有关于贵公司特定产品的信息...
```
...
```
用户：这个医疗建议的依据是什么？​模型：这是基于一般医学知识...（无法提供具体出处）
```
...
![无法获取该图片](https://oss.open8gu.com/RAG_CASE.png)
...
![无法获取该图片](https://oss.open8gu.com/iShot_2026-02-08_21.46.14.png)

### 2. RAG 核心流程

RAG 全链路图：`ingest → chunk → embed → index → retrieve → answer`。

![无法获取该图片](https://oss.open8gu.com/image-20260213144311586.png)
...
![无法获取该图片](https://oss.open8gu.com/20260204%E5%8F%91%E7%A8%BF_1.png)
...
![无法获取该图片](https://oss.open8gu.com/image-20260213171649839.png)
...
> Source: https://t.zsxq.com/wBsEm
> Resolved: https://articles.zsxq.com/id_80e7w4map98n.html
